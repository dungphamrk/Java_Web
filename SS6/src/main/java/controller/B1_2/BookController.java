...
import model.B1_2.Book;
import service.B1_2.BookService;
        ...
        try {
            switch(action == null ? "" : action) {
                ...
                case "edit":
                    ...
                    req.getRequestDispatcher("views/B1_2/lib/formEdit.jsp").forward(req, resp);
                    break;
                default:
                    ...
                    req.getRequestDispatcher("views/B1_/lib/listBook.jsp").forward(req, resp);
                    break;
            }
