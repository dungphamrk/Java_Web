...
<html>
    ...
    <body>
        ...
        <br>
        <a href="${pageContext.request.contextPath}/B8/order">B8</a>
        <br>
        <a href="${pageContext.request.contextPath}/finance">B9</a>
        <br>
        <a href="${pageContext.request.contextPath}/category">B10</a>
    </body>
</html>